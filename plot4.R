...
plot(pow$datetime, pow$Voltage, ylab ="Voltage", xlab = "", col="#ffffff", sub = 'datetime')
...
legend("topright", legend = c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"), 
       lwd = c(1, 1, 1), col=c("black", "red", "blue"), bty = 'n', cex = .95)

plot(pow$datetime, pow$Global_reactive_power, ylab = "Global_reactive_power", xlab = "", col = '#ffffff', sub = 'datetime')
